...
; *******S
	PHA					; save the accu 
		; "Clear display" (0000 0001)  
		LDA #LCD_CLS 			
		JSR LCD_SEND_INSTR		; instr_to_lcd includes wait for lcd ready 
...
?dontadd40: 
		...
		JSR LCD_SEND_INSTR	; send %1r00cccc with RS=RW=0 to lcd 
	PLX
	PLY
	PLA
	RTS
...
?next_char1: 
		...
		JSR LCD_SEND_CHAR 		; if char is not null, print on LCD
		INX 					; inc index 
